...
2.  <https://github.com/stagemonitor/spring-petclinic> 주소로 접속해서 , “Fork”
    버튼 클릭
...
3.  “Create new file”을 클릭하고 아래 라인을 복사해서 붙인다, 파일이름은
    “Dockerfile”로 한다.
...
7.  다음 지정된 위치를 찾아가서, “hsqldb” 파트를 주석 처리하고 “mysql” 파트의
    주석을 푼다.
...
13.  변경 사항을 적용하기 위해 “Commit changes” 클릭.

14.  새로운 브라우저 탭을 오픈해서 <https://hub.docker.com/>에 접속하여
    당신의docker hub 계정에 로그인 한다.

![](media/395ea771bca90eeecc8f1b98f7f7997c.png)

15.  TOP 메뉴에 있는 “Create”를 클릭하고 “Create Automated Build”를 선택한다.

![](media/bd4fd7ce46703407ed25d788b2d003e0.png)

![](media/0e77d8d4009339cfdf52e5996888d8c9.png)

16.  Github에서 가져올 것이기 때문에 왼쪽 해당부분을 클릭.

![](media/65f09f3cfdf8a010fc40c8a645a513f6.png)

17.  “spring-petclinic” 클릭 .

![](media/8ef1b9a19e6e47c37eb356d1314d96b6.png)

18.  Short description 필드에 “spring-petclinic-docker” 입력 후 , “Create” 클릭.

![](media/e4738cfe6d906079ce355e1204ba008a.png)

19.  “Build Settings” 클릭, Dockerfile Location필드에 “/Dockerfile” 입력.
...
21.  이제 Docker 이미지 구축을 위한 준비 작업이 완료되었습니다, “Trigger”를
    클릭하여 발동 조치를 하십시오

![](media/2c304f51baf3f832223e6c837ae757d7.png)

22.  Building 경과를 모니터링 하기 위해서 “Build Details”클릭.

![](media/e7891fcd6be06ee391ad35af14e3b540.png)

23.  진행 사항 확인을 위해 “F5”를 누르면 Building 업무의 상태가 몇 분 후
    “Success”로 변경된다.

![](media/d4af1ca5438ed80ab740ff211b470665.png)

24.  결과 체크를 위해 “Tags” 클릭.
...
2.  “Advanced Editor” 클릭해서 “Docker Compose” 포맷과 유사한 YAML Stack
    editor를 띄운다.
...
4.  “Done” 클릭，그런 후에 Stack 이름은 “petclinic”으로 입력한다.

![](/media/image33.png)
------------------------------------------

5.  정의된 Stack을 완료하기 위해 “Save” 클릭.

![](media/3aa344559e2f28863beeffcea30c0d5b.png)

6.  Petclinic애플리케이션 인스턴스를 배포하기 위해 “Deploy”를 클릭, Stack
    인스턴스에 대해서 Default 파라미터 유지.

![](media/6eb3af9e481370bbd817f7ebbdcedb93.png)

7.  “Deploy” 클릭, 진행상태 바에서 Stack 인스턴스의 두 개의 container가 생성되는
    것을 보여줍니다.
...
12.  “Find Owner” 클릭, 조건이 없는 애완동물과 소유주 정보가 나열 될 것 입니다..
...
10.  Github 웹사이트로 돌아가서, 당신의 GitHub 계정으로 로그인 합니다. 이전
...
11.  “Clone or download” 클릭.

![](media/60afc8c1d55f144e2c650e2e26a7edd2.png)

12.  주소 링크 복사를 위해서 카메라 아이콘을 클릭

![](media/ebb9e3076aa8f34e28b37b5e6868b60d.png)

13.  Eclipse IDE로 돌아가서, "URI"항목에 커서를 놓고 마우스 오른쪽 버튼을
...
8.  명백히, 페이지는 우리에게 새로운 내용을 보여주고 있습니다. 여기까지 잘
