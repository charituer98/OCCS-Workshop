...
1.  Deployments 페이지가 나타나 방금 만든 배포의 진행 세부 정보가 표시됩니다.
...
3.  Create Automated build 페이지에서 다음을 수행하십시오.
...
1.  Click on the name of the host in the **Hostname** 컬럼에서 호스트의 이름을
